...
<head>
	...
	<meta name="description" content="Sputnikweb Contenido para lanzamiento de la linea de soporte desarrollo y tienda virtual. (medellin colombia)" >
	<meta name="author" content="sputnikweb">
...
<body>
	...
	<div id="main-menu" class="navbar navbar-default navbar-fixed-top" role="navigation">
		...
		<nav class="collapse navbar-collapse">
			...
			<ul id="headernavigation" class="nav navbar-nav">
				...
				<!-- <li><a href="#subscribe">Subscripcion</a></li> -->
		...
		<div class="pattern height-resize">
			<div class="container">
				...
				<p class="section-description">
					Somos un grupo de especialistas profesional, enfocado a cada segmento de las tecnologias TIC, capacitados para brindar una asesoría oportuna y agil según su requerimiento.
						...
						<div class="col-sm-4">
							<div class="team-member">
								<figure>
									...
									<figcaption>
										<p class="member-name">Jairo A. Mejia R.</p>
										<p class="designation">
											CEO Experto TI
										</p><!-- /.designation -->
								...
								<div class="social-btn-container">
									<div class="team-socail-btn">
										<span class="social-btn-box facebook-btn-container">
											<a href="https://www.facebook.com/hentadwer" class="facebook-btn">
												<i class="fa fa-facebook"></i>
											</a><!-- /.facebook-btn -->
										</span><!-- /.social-btn-box -->

										<span class="social-btn-box twitter-btn-container">
											<a href="https://twitter.com/hentadwer" class="twitter-btn">
												<i class="fa fa-twitter"></i>
											</a><!-- /.twitter-btn -->
										</span><!-- /.social-btn-box -->

										<span class="social-btn-box linkedin-btn-container">
											<a href="https://co.linkedin.com/in/jairo-mejia-4263a9121" class="linkedin-btn">
												<i class="fa fa-linkedin"></i>
											</a><!-- /.linkedin-btn -->
										</span><!-- /.social-btn-box -->

										<span class="social-btn-box github-btn-container">
											<a href="https://github.com/hentadwer" class="github-btn">
						...
						<div class="col-sm-4">
							<div class="team-member">
								...
								<div class="social-btn-container">
									<div class="team-socail-btn">
										<span class="social-btn-box facebook-btn-container">
											<a href="https://www.facebook.com/yeison.aristizabal.3950" class="facebook-btn">
												<i class="fa fa-facebook"></i>
											</a><!-- /.facebook-btn -->
										</span><!-- /.social-btn-box -->

										<span class="social-btn-box twitter-btn-container">
											<a href="https://twitter.com/yeison34k" class="twitter-btn">
												<i class="fa fa-twitter"></i>
											</a><!-- /.twitter-btn -->
										</span><!-- /.social-btn-box -->

										<span class="social-btn-box linkedin-btn-container">
											<a href="https://co.linkedin.com/in/yeison-aristizabal-55991bb0/en" class="linkedin-btn">
												<i class="fa fa-linkedin"></i>
											</a><!-- /.linkedin-btn -->
										</span><!-- /.social-btn-box -->

										<span class="social-btn-box github-btn-container">
											<a href="https://github.com/kaos34k" class="github-btn">
												<i class="fa fa-github-alt"></i>
											</a><!-- /.github-btn -->
										</span><!-- /.social-btn-box -->
									</div><!-- /.team-socail-btn -->
						...
						<div class="col-sm-4">
							<div class="team-member">
								...
								<div class="social-btn-container">
									<div class="team-socail-btn">
										<span class="social-btn-box facebook-btn-container">
											<a href="https://www.facebook.com/jtoroa" class="facebook-btn">
												<i class="fa fa-facebook"></i>
											</a><!-- /.facebook-btn -->
										</span><!-- /.social-btn-box -->

										<span class="social-btn-box twitter-btn-container">
											<a href="https://twitter.com/juanchotoro24" class="twitter-btn">
												<i class="fa fa-twitter"></i>
											</a><!-- /.twitter-btn -->
										</span><!-- /.social-btn-box -->

										<!--<span class="social-btn-box linkedin-btn-container">
											<a href="https://co.linkedin.com/in/juan-fernando-toro-01372095/en" class="linkedin-btn">
												<i class="fa fa-linkedin"></i>
											</a><!-- /.linkedin-btn -->
										</span> <!-- /.social-btn-box -->
						...
						<div class="col-sm-4">
							<div class="team-member">
								...
								<div class="social-btn-container">
									<div class="team-socail-btn">
										<span class="social-btn-box facebook-btn-container">
											<a href="https://www.facebook.com/bastianoso" class="facebook-btn">
												<i class="fa fa-facebook"></i>
											</a><!-- /.facebook-btn -->
										</span><!-- /.social-btn-box -->

										<span class="social-btn-box twitter-btn-container">
											<a href="https://twitter.com/sebasosorn0" class="twitter-btn">
												<i class="fa fa-twitter"></i>
											</a><!-- /.twitter-btn -->
										</span><!-- /.social-btn-box -->
	...
	<!-- <section id="subscribe" class="section-style" data-background-image="images/background/newsletter.jpg">
		<div class="pattern height-resize">
			<div class="container">
				...
				<!--<p class="section-description">
					Recibe noticias, adelantos y toda la información acerca de nuestras novedades, también puedes encontrar más información siguiéndonos en nuestras redes sociales.
				</p><!-- /.section-description -->

				<!--<form class="news-letter" action="php/subscribe.php" method="post">
					<div class="subscribe-hide">
						<input class="form-control" type="email" id="subscribe-email" name="subscribe-email" placeholder="Correo Electronico"  required>
				...
				<!-- <div class="social-btn-container">
					<span class="social-btn-box">
						<a href="https://www.facebook.com/sputnikweb/" class="facebook-btn">
						<i class="fa fa-facebook"></i></a>
					</span><!-- /.social-btn-box -->

					<!-- <span class="social-btn-box">
						<a href="https://twitter.com/SputnikwebCo" class="twitter-btn"><i class="fa fa-twitter"></i></a>
					</span><!-- /.social-btn-box -->
					...
					<!-- <span class="social-btn-box">
						<a href="https://aboutme.google.com/b/117826726175841628562/" class="google-plus-btn"><i class="fa fa-google-plus"></i></a>
					</span><!-- /.social-btn-box -->


					<!--<span class="social-btn-box">
						<a href="https://www.youtube.com/channel/UCbLj3j_XOflU2WxxfWpKcYg" class="youtube-btn"><i class="fa fa-youtube"></i></a>
					</span><!-- /.social-btn-box -->
	...
	<section id="contact" class="section-style" data-background-image="images/background/contact.jpg">
		<div class="pattern height-resize">
			<div class="container">
				...
				<p class="section-description">
					¿Cómo podemos Ayudarte? Puedes comunicarte con nosotros y dirigir tus consultas, te asesoraremos en lo que necesites,
					Asesoría tecnológica, Desarrollo Web, web Hosting, Soporte Técnico, venta y adquisición de equipos informáticos,
					también puedes encontrar más noticias y novedades siguiéndonos en nuestras redes sociales.
				</p><!-- /.section-description -->
				...
				<form id="contact-form" action="#" method="post" class="clearfix">
					<div class="contact-box-hide">
						...
						<div class="col-sm-6">
							<input type="text"  class="form-control" id="last_name" name="last_name" required placeholder="Apellido">
							<span class="last-name-error"></span>
						</div>
						<div class="col-sm-6">
							<input type="email" class="form-control"  id="contact_email" name="contact_email" required placeholder="Correo Electronico">
				...
				<div class="social-btn-container"> <!--.social-btn-container -->
					<span class="social-btn-box">
						<a href="https://www.facebook.com/sputnikweb/" class="facebook-btn">
						<i class="fa fa-facebook"></i></a>
					</span><!-- /.social-btn-box -->
	...
	<footer id="footer-section">
		<p class="copyright">
			&copy; <a href="http://sputnikweb.co/html/kite/">SPUTNIKWEB.CO</a> 2007-2016, Todos Los derechos Reservados, Pbx: 5036084 Tel: 2730561 Cel: 3043582256 Email: sputnikkweb@gmail.com Nit:1037571547-1 Medellin - Colombia
		</p>
